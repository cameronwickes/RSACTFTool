...
if RSAToolOutput in ["P","Q"] and findIfOptionInInputs("N",RSAToolInputs) and (findIfOptionInInputs("P",RSAToolInputs) or findIfOptionInInputs("Q",RSAToolInputs)):
...
elif "P" in RSAToolOutput and findIfOptionInInputs("PHI",RSAToolInputs) and (findIfOptionInInputs("P",RSAToolInputs) or findIfOptionInInputs("Q",RSAToolInputs)):
...
elif "N" in RSAToolOutput and findIfOptionInInputs("PHI",RSAToolInputs) and (findIfOptionInInputs("P", RSAToolInputs) or findIfOptionInInputs("Q", RSAToolInputs)):
    phi = getValueOptionFromInputs("PHI", RSAToolInputs)
    if findIfOptionInInputs("P", RSAToolInputs):
        p = getValueOptionFromInputs("P", RSAToolInputs)
        q = findPQFromPhi(p,phi)
...
elif "PHI" in RSAToolOutput and findIfOptionInInputs("N",RSAToolInputs) and (findIfOptionInInputs("P", RSAToolInputs) or findIfOptionInInputs("Q", RSAToolInputs)):
    n = getValueOptionFromInputs("N", RSAToolInputs)
    if findIfOptionInInputs("P", RSAToolInputs):
        p = getValueOptionFromInputs("P", RSAToolInputs)
        q = findPQFromN(n, p)
...
elif "E" in RSAToolOutput and findIfOptionInInputs("N",RSAToolInputs) and not findIfOptionInInputs("P",RSAToolInputs) and not findIfOptionInInputs("Q",RSAToolInputs):
    n = getValueOptionFromInputs("N",RSAToolInputs)
...
elif "D" in RSAToolOutput and findIfOptionInInputs("E",RSAToolInputs) and findIfOptionInInputs("P",RSAToolInputs) and findIfOptionInInputs("Q",RSAToolInputs):
    p = getValueOptionFromInputs("P",RSAToolInputs)
    q = getValueOptionFromInputs("Q",RSAToolInputs)
    e = getValueOptionFromInputs("E",RSAToolInputs)
    phi = findPhiFromPQ(p,q)
...
elif "PT" in RSAToolOutput and findIfOptionInInputs("CT",RSAToolInputs) and findIfOptionInInputs("D",RSAToolInputs) and findIfOptionInInputs("N",RSAToolInputs):
    ct = getValueOptionFromInputs("CT",RSAToolInputs)
    d = getValueOptionFromInputs("D",RSAToolInputs)
    n = getValueOptionFromInputs("N",RSAToolInputs)
    pt = findPTFromCTDN(ct,d,n)
    RSAToolOutputValue = pt

elif "PT" in RSAToolOutput and findIfOptionInInputs("CT",RSAToolInputs) and findIfOptionInInputs("D",RSAToolInputs) and findIfOptionInInputs("P",RSAToolInputs) and findIfOptionInInputs("Q",RSAToolInputs):
    ct = getValueOptionFromInputs("CT",RSAToolInputs)
    d = getValueOptionFromInputs("D",RSAToolInputs)
    p = getValueOptionFromInputs("P",RSAToolInputs)
    q = getValueOptionFromInputs("Q", RSAToolInputs)
...
elif "PT" in RSAToolOutput and findIfOptionInInputs("E",RSAToolInputs) and findIfOptionInInputs("Phi",RSAToolInputs) and (findIfOptionInInputs("P",RSAToolInputs) or findIfOptionInInputs("Q",RSAToolInputs)) and findIfOptionInInputs("CT",RSAToolInputs):
    ct = getValueOptionFromInputs("CT", RSAToolInputs)
    e = getValueOptionFromInputs("E", RSAToolInputs)
    phi = getValueOptionFromInputs("PHI", RSAToolInputs)
    if findIfOptionInInputs("P", RSAToolInputs):
...
elif "PT" in RSAToolOutput and findIfOptionInInputs("CT",RSAToolInputs) and findIfOptionInInputs("E",RSAToolInputs) and findIfOptionInInputs("P",RSAToolInputs) and findIfOptionInInputs("Q",RSAToolInputs):
    p = getValueOptionFromInputs("P", RSAToolInputs)
    q = getValueOptionFromInputs("Q", RSAToolInputs)
    ct = getValueOptionFromInputs("CT", RSAToolInputs)
    e = getValueOptionFromInputs("E", RSAToolInputs)
...
elif "PT" in RSAToolOutput and findIfOptionInInputs("N",RSAToolInputs) and findIfOptionInInputs("E",RSAToolInputs) and findIfOptionInInputs("CT",RSAToolInputs):
    n = getValueOptionFromInputs("N",RSAToolInputs)
    e = getValueOptionFromInputs("E", RSAToolInputs)
    ct = getValueOptionFromInputs("CT", RSAToolInputs)
    if (n / e) > 100000 and e < 10000:
        pt, exact = gmpy2.iroot(ct, e)
        RSAToolOutputValue = pt
    else:
        factors = findFactorsFromN(n)
        if n == reduce(lambda x, y: x * y, factors):
            phi = 1
...
elif "CT" in RSAToolOutput and findIfOptionInInputs("P",RSAToolInputs) and findIfOptionInInputs("Q",RSAToolInputs) and findIfOptionInInputs("E",RSAToolInputs) and findIfOptionInInputs("PT",RSAToolInputs):
    p = getValueOptionFromInputs("P", RSAToolInputs)
    q = getValueOptionFromInputs("Q", RSAToolInputs)
...
elif "CT" in RSAToolOutput and findIfOptionInInputs("N",RSAToolInputs) and findIfOptionInInputs("E",RSAToolInputs) and findIfOptionInInputs("PT",RSAToolInputs):
    pt = getValueOptionFromInputs("PT", RSAToolInputs)
    e = getValueOptionFromInputs("E", RSAToolInputs)
    n = getValueOptionFromInputs("N", RSAToolInputs)
    ct = findCTFromPTEN(pt,e,n)
...
elif RSAToolOutput in ["P","Q"] and findIfOptionInInputs("N",RSAToolInputs) and (not findIfOptionInInputs("Q",RSAToolInputs) or not findIfOptionInInputs("P",RSAToolInputs)):
    n = getValueOptionFromInputs("N",RSAToolInputs)
    factors = findFactorsFromN(n)
    if len(factors) == 2:
        p = factors[0]
